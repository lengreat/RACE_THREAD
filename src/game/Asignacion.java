...
public class Asignacion {
  ...
  public Asignacion(int tam) {
    this.tam = tam;
    num();// lleno a[] de numeros aleatorios en orden aleatorio
  }
  ...
  public void num() {
    ...
    do {
      ...
      if (repetidoAleatorio) {// si encontro un repetido no incrementa y continua el loop
        a[stop] = i;// el numero aleatorio asignado es unico
        stop++;
      }
    } while (stop < a.length);// Hasta llenar todo el arreglo
  }
}